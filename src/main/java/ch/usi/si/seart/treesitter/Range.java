...
/**
 * Represents the portions of source code taken up by a node within a file or snippet. Each range
 * consists of a:
 *
 * <ul>
 *   <li>start byte offset
 *   <li>end byte offset
 *   <li>start point
 *   <li>end point
 * </ul>
...
public class Range {
  ...
  /**
   * Facilitates the construction of {@link Range} instances. It allows for the step-by-step
  ...
  public static final class Builder {
     ...
     * @throws IllegalArgumentException if the start byte is greater than the end byte, or if the
     *     start point is greater than the end point
