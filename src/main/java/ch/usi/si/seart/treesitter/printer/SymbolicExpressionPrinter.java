...
/**
 * Printer used for generating Symbolic Expression (S-expression) representations of trees using an
 * iterative approach. Note that unlike the CLI counterpart, the resulting symbolic expression does
 * not contain the positional information of the node.
 *
 * @since 1.4.0
 * @see <a
 *     href="https://github.com/tree-sitter/tree-sitter/blob/293f0d1ca30a63839810ad4b943c0f19f1cb4933/cli/src/parse.rs#L130-L184">Rust
 *     implementation</a>
 * @author Ozren Dabić
 */
