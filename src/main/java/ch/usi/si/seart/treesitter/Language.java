 ...
 *
 * <p>Only languages whose ABI version is within the range of the library's supported versions are
 * included in this enum. For this reason, the enum is not exhaustive and may not include all
 * languages developed by the community.
 *
 * @since 1.0.0
 * @author Ozren Dabić
...
public enum Language {
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter-grammars/tree-sitter-arduino">tree-sitter-arduino</a>
   */
  ARDUINO(arduino(), "ino"),
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter-grammars/tree-sitter-commonlisp">tree-sitter-commonlisp</a>
   */
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter/tree-sitter-embedded-template">tree-sitter-embedded-template</a>
   */
   ...
   *
   * @see <a
   *     href="https://github.com/ObserverOfTime/tree-sitter-gitattributes">tree-sitter-gitattributes</a>
   */
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter-grammars/tree-sitter-markdown">tree-sitter-markdown</a>
   */
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter-grammars/tree-sitter-properties">tree-sitter-properties</a>
   */
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter-grammars/tree-sitter-requirements">tree-sitter-requirements</a>
   */
   ...
   *
   * @see <a
   *     href="https://github.com/tree-sitter-grammars/tree-sitter-thrift">tree-sitter-thrift</a>
   */
  ...
  public static void validate(@NotNull Language language) {
    ...
    if (version < minimum || version > maximum) throw new ABIVersionError(version);
  }

  /**
   * Selects enum values <em>potentially</em> associated with a file at a given path. This method
   * checks the file's extension or name to determine the candidate language(s). Returns an empty
   * collection if no associations can be made to a file.
   *
   ...
   *     <ul>
   *       <li>{@code state} &lt; 0
   *       <li>{@code state} &ge; {@link #totalStates}
   *     </ul>
   *
   * @since 1.12.0
   */
   ...
   *
   * <p>Combine this with lookahead iterators to generate completion suggestions or valid symbols in
   * {@code ERROR} nodes.
   *
   * @param node the node
   * @return the next parse state
   * @throws NullPointerException if {@code node} is null
   * @throws IllegalArgumentException if this language was not used to parse the node and its syntax
   *     tree
   * @since 1.12.0
   */
  ...
  /**
   * @deprecated Just calculate the {@link List#size() size} of the list returned by {@link
   *     #symbols} getter.
   */
  @Generated
  ...
  /**
   * @deprecated Just calculate the {@link List#size() size} of the list returned by {@link #fields}
   *     getter.
   */
  @Generated
  @Deprecated(forRemoval = true, since = "1.12.0")
  ...
  /**
   * Represents Git metadata related to the grammar submodule that a language was built from. It is
   * intended as a more fine-grained alternative to the ABI {@link Language#version}. Since
   * community-developed grammars tend to veer from guidelines imposed by the original developers,
   * said version number can not be used to reliably track the current iteration of the grammar. It
   * is worth noting that some metadata (like tags) may not be present for all languages.
   *
   * @author Ozren Dabić
   * @since 1.11.0
   */
