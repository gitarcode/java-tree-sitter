...
/**
 * A Tree represents the syntax tree of an entire source code file. It contains {@link Node}
...
public class Tree extends External implements Iterable<Node>, Cloneable {
   ...
   *
   * @param edit changes made to the source code in terms of <strong>both</strong> byte offsets and
   ...
   *
   * <p>For this to work correctly, this syntax tree must have been edited such that its ranges
   * match up to the new tree. Generally, you'll want to call this method right after calling one of
   * the {@link Parser} methods.
   *
